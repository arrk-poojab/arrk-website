...
<script>
	$(document).ready(function() {
		$(".contact-info-toggle").click(function() {
			$(".contactInfo-admin .contactLink").toggle(500);
			$(".contactInfo-admin .contactNumber").toggle(500);
			$(".contactInfo-admin").toggle(500);
			$(".adminInfo").toggle(500);
			$(".close-btn").toggle(500);
			//$(this).html(($('.contact-info-toggle').text() == '+ Show Search and Contact Info') ? '- Hide Search and Contact Info' : '+ Show Search and Contact Info');
		});
		
		$(".close-btn").click(function() {
			$(".contactInfo-admin .contactLink").css("display","none");
			$(".contactInfo-admin .contactNumber").css("display","none");
			$(".contactInfo-admin").css("display","none");
