...
<div class="contentContainer">
  <div class="container_12">
    ...
    <!--Channel [End]-->
	  ...
	  <div class="grid_5 padding-right-20 padding-left-40 margin-top-30 margin-bottom100">		
				...
				<dl>
					...
					<dd>
						<input type='submit' class="btn floatRight" value="Login" />
						 <input type='checkbox' class='chk left-float margin-top18' name='_spring_security_remember_me' id='remember_me'
						<g:if test='${hasCookie}'>checked='checked'</g:if> />	<label for='remember_me' class="padding-left-5 margin-top15"><g:message code="login.rememberMe.label"/></label>
					</dd>
					<dd class="separator-top padding-top-10">		    					
					   	<span class="right-float"><g:link controller='login' action="forgetPassword" ><g:message code='Forgot Password'/></g:link></span>				
						<span class="left-float"><g:link controller='register'  params='["returnToUrl":"${goTopath}"]'><g:message code='Register'/></g:link></span>
					</dd>
				</dl>	
			</fieldset>
		</form>
