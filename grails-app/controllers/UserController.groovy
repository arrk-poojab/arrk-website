...
class UserController {
	...
	def save = {
	   ...
	   println("params.organisation: "+params.organisation)
	   println("params.jobtitle: "+params.jobtitle)
	   println("params.phone: "+params.phone)
	   println("params.interest: "+params.interest)
	...
	private void addRoles(person) {
		...
		for (String key in params.keySet()) {
			...
			if (key.contains('ROLE') && 'on' == params.get(key)) {
				...
				flag = true;
			}else if (key.contains('ROLE') && 'on' != params.get(key) && (flag == false)){
		
			    Role.findByAuthority(defaultRole).addToPeople(person)
			}
		}
	}
