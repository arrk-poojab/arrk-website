class UrlMappings {
	...
	static mappings = {
		...
		"/emailDisclaimer"(view:'/emailDisclaimer')
		...
		"/forgetPassword" (controller: "login", action: "forgetPassword")
		"/forgotPasswordSendMail" (controller: "login", action: "forgotPasswordSendMail")
		...
		//Default error
		"500"(view:'/pageNotFound')
		"400"(view: '/pageNotFound')
		"403"(view: '/pageNotFound')
